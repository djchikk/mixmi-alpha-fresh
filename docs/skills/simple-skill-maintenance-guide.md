...
Every skill gets this header (Claude Desktop requires this exact structure):
...
**Note:** The versioning info must be inside `metadata:` for Claude Desktop compatibility.
...
```yaml
# Minimal viable skill header for Claude Desktop
---
