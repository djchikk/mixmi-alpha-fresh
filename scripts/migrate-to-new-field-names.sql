-- =================================================================
-- MIGRATE TO NEW COLLABORATION SYSTEM FIELD NAMES
-- =================================================================
...
-- Step 3: Add new licensing fields with proper names
...
-- Step 5: Clean up old fields (optional - comment out if you want to keep them)
-- ALTER TABLE ip_tracks DROP COLUMN agree_permissions;
-- ALTER TABLE ip_tracks DROP COLUMN agree_collab;
-- ALTER TABLE ip_tracks DROP COLUMN licensed_by;

-- =================================================================
-- VERIFICATION: Check the new field names
-- =================================================================
SELECT 
    title,
