-- Update initialize_user_profile function to explicitly set sticker defaults
-- This ensures new profiles have the blue daisy sticker visible by default
...
BEGIN
  ...
  -- Insert profile if it doesn't exist, with sticker visible by default
