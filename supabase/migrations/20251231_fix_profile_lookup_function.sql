-- Migration: Fix get_profile_by_identifier function
-- Corrects column references: removes btc_address (doesn't exist), adds sui_address
-- Also adds SUI address lookup capability
