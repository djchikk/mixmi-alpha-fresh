        ...
        <div className="max-w-2xl mx-auto mb-16" style={{
          ...
          <div className="mb-8">
            ...
            <p className="text-[#a8b2c3] text-sm leading-relaxed" style={{ fontFamily: 'var(--font-geist-mono)' }}>
              Discover sounds and visuals from creators worldwide. Browse content pinned to Earth's surface, preview instantly, and drag anywhere—mixer, playlist, crate. The globe is your gateway to the mixmi community and beyond.
            </p>
          </div>
          ...
          <div className="mb-8">
            ...
            <p className="text-[#a8b2c3] text-sm leading-relaxed mb-4" style={{ fontFamily: 'var(--font-geist-mono)' }}>
              Dual decks for sound and video, each with real-time FX. Drag content from anywhere, blend freely, and make something new.
            </p>
            ...
            <div className="mt-4 space-y-2">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#A084F9' }}></div>
                  <span className="text-[#a8b2c3] text-xs" style={{ fontFamily: 'var(--font-geist-mono)' }}>Loops</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#FFC044' }}></div>
                  <span className="text-[#a8b2c3] text-xs" style={{ fontFamily: 'var(--font-geist-mono)' }}>Radio Stations</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#A8E66B' }}></div>
                  <span className="text-[#a8b2c3] text-xs" style={{ fontFamily: 'var(--font-geist-mono)' }}>Songs</span>
                </div>
                <div className="flex items-center gap-2">
                  <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#5BB5F9' }}></div>
