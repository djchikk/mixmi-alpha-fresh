...
export default function AppleAuthCallbackPage() {
  ...
  useEffect(() => {
    ...
    async function completeZkLogin() {
      try {
        console.log('🍎 Apple Step 1: Extracting JWT from URL...');
        ...
        console.log('🍎 Apple Step 2: Getting pending zkLogin state...');
        ...
        console.log('🍎 Apple Step 3: Decoding JWT payload...');
        ...
        console.log('🍎 JWT decoded - email:', appleEmail || '(hidden by user)');

        console.log('🍎 Apple Step 4: Reconstructing ephemeral keypair...');
        ...
        console.log('🍎 Apple Step 5: Calling salt API...');
        ...
        console.log('🍎 Apple Step 6: Getting ZK proof from Mysten Labs prover...');
        ...
        console.log('🍎 Apple Step 7: Deriving SUI address...');
        ...
        console.log('🍎 Apple Step 8: Completing authentication...');
        ...
        console.log('🍎 Apple Step 9: Storing session...');
        ...
        console.log('🍎 Apple Step 10: Storing auth in localStorage...');
        ...
        console.log('🍎 ✅ Apple zkLogin complete! Redirecting to /account...');
        setStatus('success');
