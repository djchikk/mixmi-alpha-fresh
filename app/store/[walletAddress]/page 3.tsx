      ...
      if (walletOrUsername.startsWith('SP') || walletOrUsername.startsWith('ST')) {
        ...
        try {
          ...
          if (!error && data) {
            ...
            console.log('Profile config:', data.profile_config);

            if (data.profile_config?.profile?.image) {
              setProfileImage(data.profile_config.profile.image);
              console.log('Profile image set:', data.profile_config.profile.image.slice(0, 100));
            } else {
              console.log('No profile image found in config');
            }
          } else {
