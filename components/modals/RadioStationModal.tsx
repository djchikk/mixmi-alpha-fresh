        ...
        <form onSubmit={handleSubmit} className="p-6 pb-24 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                style={{
                  ...
                  borderColor: contentType === 'radio_station' ? '#FFC044' : 'rgba(255, 255, 255, 0.08)',
                  color: contentType === 'radio_station' ? '#FFC044' : '#8b92a6',
                  borderRadius: '12px'
                }}
                disabled={isUploading}
              >
              ...
              <button
                ...
                style={{
                  ...
                  borderColor: contentType === 'station_pack' ? '#FFC044' : 'rgba(255, 255, 255, 0.08)',
                  color: contentType === 'station_pack' ? '#FFC044' : '#8b92a6',
                  borderRadius: '12px'
                }}
                disabled={isUploading}
              >
          ...
          <div>
            ...
            <input
              ...
              } rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFC044]`}
          ...
          <div>
            ...
            <textarea
              ...
              } rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFC044] resize-none`}
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 bg-[#0f172a] border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFC044] resize-none"
          ...
          <div>
              ...
              {packStations.map((station, index) => (
                <div key={index} className="bg-[#0f172a] border border-white/10 rounded-lg p-4">
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-[#FFC044]/20 flex items-center justify-center text-[#FFC044] font-medium text-sm mt-2">
                      {index + 1}
                    </div>
                    <div className="flex-1 space-y-3">
                      <div>
                        <input
                          ...
                          className="w-full px-3 py-2 bg-[#1a2332] border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFC044] text-sm"
                      ...
                      <div>
                        <input
                          ...
                          } rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFC044] text-sm`}
            ...
            <button
              type="button"
              onClick={addStation}
              className="mt-3 w-full px-4 py-2 bg-[#FFC044]/10 hover:bg-[#FFC044]/20 border border-[#FFC044]/30 text-[#FFC044] rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-[#0f172a] border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#FFC044]"
            ...
            {isLoadingLocations && (
              <div className="absolute right-3 top-11 transform">
                <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#FFC044]"></div>
              </div>
            )}
              ...
              >
                {suggestions.map((suggestion: any) => (
                  <button
                    key={suggestion.id}
                    type="button"
                    className="w-full px-4 py-3 text-left hover:bg-[#FFC044]/20 transition-colors border-b border-slate-700 last:border-b-0 text-white"
                    onClick={(e) => {
                      e.preventDefault();
                      e.stopPropagation();
            ...
            {tags.length > 0 && (
              <div className="flex flex-wrap gap-2 mt-2">
                {tags.map((tag, index) => (
                  <span
                    key={index}
                    className="bg-[#FFC044]/20 text-[#FFC044] px-3 py-1 rounded-full text-sm flex items-center gap-2"
                  >
                    {tag}
                    <button
                      type="button"
          ...
          <div className="space-y-4">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 mt-0.5 bg-slate-800 border-slate-600 rounded text-[#FFC044] focus:ring-[#FFC044]"
              />
              <div className="flex-1">
                ...
                <a
                  ...
                  className="block text-[#FFC044] hover:text-[#FFC044]/80 text-sm mt-1"
                >
                  View Terms →
                </a>
              </div>
          ...
          <div className="flex gap-4 pt-4 border-t border-white/10">
            ...
            <button
              type="submit"
              className="flex-1 px-6 py-3 bg-[#FFC044] hover:bg-[#FFC044]/90 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
