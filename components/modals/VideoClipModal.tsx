...
export default function VideoClipModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-gradient-to-br from-[#1a2332] to-[#0f1419] rounded-2xl shadow-2xl w-full max-w-3xl border border-[#10B981]/30 my-8">
        {/* Header */}
        ...
        <div className="p-6 space-y-6 max-h-[70vh] overflow-y-auto">
          ...
          <div>
            ...
            {!videoPreviewUrl ? (
              <div
                ...
                className="border-2 border-dashed border-[#10B981]/30 hover:border-[#10B981] rounded-lg p-8 text-center cursor-pointer transition-colors bg-[#10B981]/5 hover:bg-[#10B981]/10"
              >
              ...
              <div className="relative rounded-lg overflow-hidden bg-black">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <button
                    ...
                    className="w-16 h-16 rounded-full bg-[#10B981]/90 hover:bg-[#10B981] flex items-center justify-center transition-colors"
                  >
                    {isPreviewPlaying ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#10B981]"
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#10B981] resize-none"
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#10B981]"
            ...
            <div className="flex flex-wrap gap-2">
              {tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 bg-[#10B981]/20 text-[#10B981] rounded-full text-sm flex items-center gap-2"
                >
                  {tag}
                  <button
          ...
          <div className="relative" ref={locationInputRef}>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-800/50 border border-slate-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#10B981]"
          ...
          <div className="bg-slate-800/30 border border-slate-700 rounded-lg p-4">
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="mt-1 w-4 h-4 rounded border-gray-600 text-[#10B981] focus:ring-[#10B981]"
                disabled={isUploading}
              />
        ...
        <div className="flex items-center justify-between p-6 border-t border-white/10">
          ...
          <button
            ...
            className="px-8 py-2 bg-gradient-to-r from-[#10B981] to-[#059669] hover:from-[#059669] hover:to-[#047857] text-white rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isUploading ? (
              <>
